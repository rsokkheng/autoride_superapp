      ...
      appBar: AppBar(
        ...
        actions: [
          PopupMenuButton<String?>(
            ...
            icon: Icon(Icons.filter_list_rounded, color: _typeFilter != null ? AppTheme.accent : context.appTextSecondary),
            ...
            itemBuilder: (_) => [
              ...
              PopupMenuItem(value: 'sos',   child: Text('SOS',         style: TextStyle(color: context.appTextPrimary))),
              PopupMenuItem(value: 'crash', child: Text('Crash',       style: TextStyle(color: context.appTextPrimary))),
              PopupMenuItem(value: 'report',child: Text('User Report', style: TextStyle(color: context.appTextPrimary))),
            ],
          ),
        ],
      ),
          ...
          : _error != null
              ...
              : _incidents.isEmpty
                  ? Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      SizedBox(height: 12),
                      Text('No safety incidents.', style: TextStyle(color: context.appTextSecondary, fontSize: 15)),
                    ]))
                  : RefreshIndicator(
                      onRefresh: _load,
                            ...
                            child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              Expanded(
                                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  Row(children: [
                                    Container(padding: EdgeInsets.symmetric(horizontal: 7, vertical: 2), decoration: BoxDecoration(color: color.withValues(alpha: 0.12), borderRadius: BorderRadius.circular(20)),
                                      child: Text(type.toUpperCase(), style: TextStyle(color: color, fontSize: 10, fontWeight: FontWeight.w700))),
                                    SizedBox(width: 8),
                                    Expanded(child: Text(user, style: TextStyle(color: context.appTextPrimary, fontWeight: FontWeight.w600, fontSize: 13), maxLines: 1, overflow: TextOverflow.ellipsis)),
                                    Container(padding: EdgeInsets.symmetric(horizontal: 6, vertical: 2), decoration: BoxDecoration(color: resolved ? AppTheme.success.withValues(alpha: 0.12) : AppTheme.danger.withValues(alpha: 0.12), borderRadius: BorderRadius.circular(20)),
                                  ...
                                  if (desc.isNotEmpty) ...[
                                    SizedBox(height: 5),
                                    Text(desc, style: TextStyle(color: context.appTextSecondary, fontSize: 12, height: 1.4), maxLines: 2, overflow: TextOverflow.ellipsis),
                                  ],
                                  if (short.isNotEmpty) ...[
                                    SizedBox(height: 4),
