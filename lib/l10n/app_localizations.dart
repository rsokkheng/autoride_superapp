...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _t = {
    'en': {
      ...
      'packageAmountHint': 'Package Amount in KHR (e.g. 20000)',
      'deliveryFee': 'Delivery Fee',
      'deliveryCompleted': 'Delivery Completed',
      'completedAt': 'Completed at',
      'completionTime': 'Completion Time',
      'deliverySummary': 'Delivery Summary',
      'viewDeliverySummary': 'View Delivery Summary',
      'feePaidBy': 'Fee Paid By',
      'paidBySender': 'Sender',
      'paidByRecipient': 'Recipient',
    ...
    'km': {
      ...
      'packageAmount': 'តម្លៃទំនិញ',
      'packageAmountHint': 'តម្លៃទំនិញគិតជារៀល (ឧ. ២០០០០)',
      'deliveryFee': 'តម្លៃសេវាដឹក',
      'deliveryCompleted': 'ការដឹកជញ្ជូនបានបញ្ចប់',
      'completedAt': 'បានបញ្ចប់នៅម៉ោង',
      'completionTime': 'ពេលបញ្ចប់ការដឹក',
      'deliverySummary': 'របាយការណ៍សង្ខេបការដឹក',
      'viewDeliverySummary': 'មើលរបាយការណ៍សង្ខេប',
      'feePaidBy': 'បង់ថ្លៃសេវាដោយ',
      'paidBySender': 'អ្នកផ្ញើ',
      'paidByRecipient': 'អ្នកទទួល',
      'serviceFee': 'តម្លៃសេវាដឹក',
      'deliveryReceipt': 'វិក្កយបត្រដឹកជញ្ជូន',
    ...
    'zh': {
      ...
      'packageSize': '包裹尺寸',
      'packageAmount': '包裹金额',
      'packageAmountHint': '包裹金额 (瑞尔，例如 20000)',
      'deliveryFee': '配送费',
      'deliveryCompleted': '配送已完成',
      'completedAt': '完成于',
      'completionTime': '完成时间',
      'deliverySummary': '配送摘要',
      'viewDeliverySummary': '查看摘要',
      'feePaidBy': '运费支付方',
      'paidBySender': '寄件人',
      'paidByRecipient': '收件人',
      'serviceFee': '服务费',
      'deliveryReceipt': '配送收据',
      'sendAnything': '随时随地\n发送任何东西!',
