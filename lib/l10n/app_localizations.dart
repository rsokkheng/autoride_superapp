...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _t = {
    ...
    'km': {
      ...
      'bookRide': 'កក់រថយន្ត',
      'bookRideSub': 'ឥឡូវ ឬ កំណត់ពេល',
      'delivery': 'ដឹកជញ្ជូន',
      'deliverySub': 'ផ្ញើកញ្ចប់លឿន',
      'marketplace': 'ផ្សារ',
      'marketplaceSub': 'ទិញ ឬ ជួលយានយន្ត',
      'evStations': 'ស្ថានីយ៍ EV',
      'evStationsSub': 'រកការសាកថ្មនៅជិតអ្នក',
      'safety': 'សុវត្ថិភាព',
      'payment': 'ការទូទាត់',
      'support': 'ជំនួយ',
